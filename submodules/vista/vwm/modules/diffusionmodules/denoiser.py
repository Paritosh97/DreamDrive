...
class Denoiser(nn.Module):
    ...
    def forward(
        ...
        # Output is directly denoised latent, NOT the noise estimated 
        # This is from EDM: Elucidating the Design Space of Diffusion-Based Generative Models
        ret = network(noised_input * c_in, c_noise, cond, cond_mask, self.num_frames)
        return (ret[0] * c_out + noised_input * c_skip, ret[1])
